#!/bin/bash
#SBATCH --job-name=eval_imf_visual_aligning
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# Model loaded via experiment='plan_imf_visual_aligning' config block.
# Results saved to: logs/aligning-d3il-visual/plans/imf_visual_aligning/<exp>/<seed>/results/
...
#   sbatch eval_imf_visual_aligning.sh 5
#   sbatch eval_imf_visual_aligning.sh 6
