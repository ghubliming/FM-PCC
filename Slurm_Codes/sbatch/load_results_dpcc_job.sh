#!/bin/bash
#SBATCH --job-name=dpcc_load_results
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# 4) Run DPCC Results Loading / Plotting
cd "$REPO"

echo "Running scripts/load_results.py..."
python scripts/load_results.py

echo "DPCC Results loading completed successfully."
