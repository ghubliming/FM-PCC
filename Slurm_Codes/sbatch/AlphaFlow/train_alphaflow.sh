...
# 4) Run AlphaFlow (Gen3v7) Training
cd "$REPO"
...
# After ANY resume, check train/alpha in W&B: the α anneal is recomputed from the
# restored step, so a rewound step would show up there first.
