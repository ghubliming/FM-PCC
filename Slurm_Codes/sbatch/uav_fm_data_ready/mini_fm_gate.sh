...
#   ./Slurm_Codes/submit.sh Slurm_Codes/sbatch/uav_fm_data_ready/mini_fm_gate.sh pillars 100 1000
# Args: $1=scene [empty]  $2=n_episodes [100]  $3=n_steps [1000]
set -e
...
echo "scene=$SCENE  n_episodes=$N_EP  n_steps=$N_STEPS"
echo "================================================================================"
...
echo "[ mini-gate ] python uav_expert_data_collect/mini_fm_sanity.py --data-dir data/uav_fm/v1/$SCENE"
python uav_expert_data_collect/mini_fm_sanity.py \
    --data-dir "data/uav_fm/v1/$SCENE" --n-episodes "$N_EP" --n-steps "$N_STEPS"
