...
for seed in selected_seeds:
    args = Parser().parse_args(experiment='fm_encdec_vision', seed=seed)
    ...
    from fm_encdec_vision.utils.scaler import Scaler
    ...
    from fm_encdec_vision.models.visual_unet import VisualUNet
    ...
    # 3. Diffusion (Engine: Flow Matching FMv3ODE)
    from fm_encdec_vision.models.visual_gaussian_diffusion import VisualGaussianDiffusion
    diffusion_config = utils.Config(
        ...
        action_dim=args.action_dim,
        goal_dim=0,
        n_timesteps=getattr(args, 'n_diffusion_steps', 16),
