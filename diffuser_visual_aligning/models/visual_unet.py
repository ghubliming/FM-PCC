...
class VisualUNet(nn.Module):
    ...
    Backbone: diffuser_visual_aligning.models.unet1d_temporal_cond.UNet1DTemporalCondModel
    ...
    def __init__(self, config):
        ...
        if self.film_mode == 'v2':
            from diffuser_visual_aligning.models.unet1d_temporal_film import UNet1DTemporalFiLMModel
