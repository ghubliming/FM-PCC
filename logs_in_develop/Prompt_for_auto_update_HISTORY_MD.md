...
| Field | Value |
|---|---|
| **Commit hash / Date** | `5092e056` / `2026-09-23` |
| **Commit message / Scope** | `Docs Upate 23-09 - II` |
| **Commit date** | 2026-09-23 20:26:55 UTC |
| **What was recorded** | Entries through September 23, 2026:<br>1. **Gen15 U18 Live Quadrotor Bridge Execution (R39, Jobs 26151–26154)** (`DA_20260923_pillars_v2_live.md`, `CHANGELOG_20260923_U18_fix8_sidecar_overwrite.md`): Evaluated 240 live flights (MeanFM, CI-MeanFM K=1, 2); confirmed unprojected transfer matches table and projected flights have 0 declared violations (78/78), but ~30–40% suffer physical pillar contacts because demonstrations skim pillars at rod radius, causing unmodeled proximity to collide with drone's 0.36m radial reach; fixed `factory.py` sidecar overwrite bug.<br>2. **Diffusion Baseline K=2 Five-Seed Protocol Resolution (R26, Job 26112)** (`DA_20260923_diffusion_K2_five_seeds.md`): Evaluated 5 seeds × 3 geometries × 2 episodes; Diffusion K=2 achieves S&C 1.000 at 61.2 steps and 211.4 ms/step, Pareto-dominating published K=20 baseline (553.4 ms); FM (25.5 ms) and CI-MeanFM (27.0 ms) maintain ~8× speedup; explained projector latency asymmetry (SLSQP solving from noisy warm-start at t=1).<br>3. **D3IL Visual Aligning Pending Rows (R2, R37, R35, Jobs 26113, 26115)** (`FROM_DA_20260923_aligning_R2_R37_R35_ready.md`): Filled Diffusion K=20 per-step (MeanFM r dominates), threshold ladder K=100/2, and CI-MeanFM endpoint block.<br>4. **UAV S-Curve Generative Grid Restructuring (R44, Jobs 26167–26176)** (`PENDING_20260923_uav_scurve_R44_raw_first.md`): Launched Phase A raw evaluation across K=1, 2, 20 to benchmark unprojected generative flight prior to projection and MJPC phases. |
