...
| Field | Value |
|---|---|
| **Commit hash / Date** | `a86f1f30` / `2026-08-30` |
| **Commit message / Scope** | `aggregated_hardflow_lowK, Gen12/Gen14 hotfixes, NLP SolverSwap SLSQP adoption, Gen15 UAV pillars audit` |
| **Commit date** | 2026-08-30 16:48:20 UTC |
| **What was recorded** | HardFlow degeneracy guard (HFK1c) universally gating n_genuine == 0 variants across 6 ports/drivers, adding config-time pruning, HF_DEGENERATE_SKIPPED.txt sentinels, HardFlowDegenerateError backstops, DA ranking table flag propagation (MAX rule), and Gate G7 test suite; NLP SolverSwap full empirical campaign (Job 25222, 2h 49m) adopting Scipy SLSQP as primary backend after proving 3.88x speedup with only 0.28% constraint degradation in 1 of 12 cells, validating HardFlow's endpoint projection design claim (31–47% cheaper projection than DPCC); Gen14 U11 empty-string env guard hotfix (Job 25215/25216) and Gen12 K_ENV_SCALAR scalar/list collision hotfix (Job 25161); SolverSwap nlp_failures backstop telemetry bugfix (remedying invisible 60s hard solver timeouts) and Gate G0 additive registration; Gen15 UAV pillars K-sweep forensic audit (Jobs 25127–25138, 1,707 rollouts) identifying 0/1707 S&C geometric channel inflation bottleneck (~12cm), 83% inverted v2 aborts at >90° tilt, strict 4-axis Pareto dominance mf > fm on UNet, chargedSteps metric standardization, and HardFlow 4–6x throughput advantage over DPCC. |