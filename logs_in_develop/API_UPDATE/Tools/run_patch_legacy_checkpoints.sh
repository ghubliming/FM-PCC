#!/bin/bash
#SBATCH --job-name=patch_checkpoint
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
TARGET_PATH="FMPCC/FM-PCC/logs/aligning-d3il-visual/fm_visual_aligning/H8_Dfm_visual_aligning.models.visual_gaussian_diffusion.VisualGaussianDiffusion_a1.5_b1.0_aw1_VTrue_steps900_bs64"
...
echo "[ patch ] Target: $TARGET_PATH"
echo "[ patch ] Flags:  ${EXTRA_FLAGS:-none}"
echo ""

# ─── Run ─────────────────────────────────────────────────────────────────────
SCRIPT="$REPO/logs_in_develop/API_UPDATE/Tools/patch_legacy_checkpoints.py"
