...
ResNet-18 towers with group normalisation, taken from D3IL \parencite{jia2024towards}, each producing
$64$ features that are concatenated to a per-frame descriptor. The descriptor is averaged over the
...
The endpoint-projection rows at small step budgets and $\eta = 0.5$ that fall into these two regimes
are listed in \autoref{sec:res:constraints:degenerate}.
