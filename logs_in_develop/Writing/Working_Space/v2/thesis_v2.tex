...
$\alpha_{\mathrm{end}}>0$, it matches analytic average-velocity matching at low step budgets and
...
\begin{table}[htpb]
  ...
  \begin{tabular}{llll}
    ...
    plan interval   & one plan per env.\ step & one plan per env.\ step & $0.03\,\textrm{s}$ simulated \\
    inner interval  & $n\sidx{sub}$ sim substeps & $n\sidx{sub}$ sim substeps & $0.01\,\textrm{s}$ simulated \\
    \bottomrule
  \end{tabular}
\end{table}
