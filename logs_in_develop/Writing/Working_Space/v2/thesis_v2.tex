...
\begin{table}[htpb]
  ...
  steps applied before the next plan is generated.}
  \label{tab:related-loops}
  \centering\small
  \begin{tabularx}{\linewidth}{lLLL}
    \toprule
    Work & Constraints & Loop and plan & Backbone \\
    \midrule
    ...
    This thesis
      ...
      & receding horizon, horizon $8$, $1$ executed, Euler plant model
      & temporal U-Net, one parameter count for every model \\
    \bottomrule
  \end{tabularx}
\end{table}
