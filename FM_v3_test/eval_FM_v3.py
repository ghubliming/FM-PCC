...
from flow_matcher_v3.sampling.policies import Policy
from flow_matcher_v3.sampling.projection import Projector
...
for exp in exps:
    for halfspace_variant in halfspace_variants:
        ...
        for seed in seeds:
            args = Parser().parse_args(experiment='plan_fm_v3', seed=seed)
            # Get model
