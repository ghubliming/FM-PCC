...
import d3il.environments.d3il.d3il_sim.controllers as ctrl
import d3il.environments.d3il.d3il_sim.core.logger as logger
import d3il.environments.d3il.d3il_sim.core.Model as model
...
class RobotBase:
    ...
    def __init__(self, scene, dt, num_DoF=7, base_position=None, base_orientation=None):
        ...
        self.torque_limit = np.array([80, 80, 80, 80, 10, 10, 10], dtype=np.float64)
    ...
    def reset(self):
        ...
        self.current_load = np.zeros((self.num_DoF,))
    ...
    def gotoCartPositionAndQuat(
        ...
        self.gotoCartPosQuatController.executeController(
            self, duration, block=block, log=log
        )
    ...
    def fing_ctrl_step(self):
        ...
        dgain = 1 * np.array([10, 10], dtype=np.float64)
