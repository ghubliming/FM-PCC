...
from d3il.environments.d3il.d3il_sim.core.Scene import Scene
from d3il.environments.d3il.d3il_sim.core.sim_object.sim_object import (
    IntelligentSimObject,
    SimObject,
)
from d3il.environments.d3il.d3il_sim.sims.mj_beta.mj_utils.mj_render_singleton import (
    reset_singleton as reset_render_singleton,
)
from d3il.environments.d3il.d3il_sim.sims.mj_beta.mj_utils.mj_renderer import Viewer
from d3il.environments.d3il.d3il_sim.sims.mj_beta.mj_utils.mj_scene_object import (
    MjSurrounding,
)
from d3il.environments.d3il.d3il_sim.sims.mj_beta.mj_utils.mj_scene_parser import (
    MjSceneParser,
)
from d3il.environments.d3il.d3il_sim.sims.mj_beta.MjCamera import MjCageCam, MjCamera
from d3il.environments.d3il.d3il_sim.sims.mj_beta.MjLoadable import (
    MjFreezable,
    MjXmlLoadable,
)
from d3il.environments.d3il.d3il_sim.utils import sim_path
...
class MjScene(Scene):
    ...
    def add_object_rt(self, new_obj: MjXmlLoadable):
        ...
        if self.render_mode == self.RenderMode.HUMAN:
            self.viewer.reinit(self.model, self.data)
