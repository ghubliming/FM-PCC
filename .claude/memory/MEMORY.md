...
- [U17 pillars_xl wave = a FLOOR, on hold](u17-pillars-xl-floor-result.md) — 53/54 projected cells success=0.00 (Sep 2026); hypothesis = goal radius 0.30 < detour+track_err; read 4 results.json (runbook §3e) before ANY more pillars compute; it is U17 not U7
