...
Last built **2026-09-19**. Every thesis figure lives in this store; drafts receive copies via `plotting/export_to_draft.py`.
...
| `fig_aligning_contexts.preview` | `env/fig_aligning_contexts.preview.png` |
