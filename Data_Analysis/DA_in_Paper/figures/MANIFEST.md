...
Last built **2026-09-20**. Every thesis figure lives in this store; drafts receive copies via `plotting/export_to_draft.py`.

## Generated

| figure | group | corpus | protocol |
| :-- | :-- | :-- | :-- |
| `fig_avoiding_paths` | da | `data/exec_paths.json (extract/exec_paths.py)` | 4 cells, 80 episodes; geometry top-right-hard, variant dpcc-t-tightened; constraint set from data/avoiding_scene.json, drawn by avoiding.geometry_panel |
