...
| §6.3.1.2 `tab:uav-pillars`, `tab:uav-pillars-endpoint` | UAV-pillars at every evaluated budget, per-step and endpoint blocks kept apart | (new, 2026-09-18) | [`pillars_grid.py`](pillars_grid.py) — `analysis_results_checkpoint/15-09/batch_uav_20260915_100816`, geometry `pillars_hg`, tags `u7hg`/`EPlatest_u7hg`, `geo_free` excluded | 10 flights per cell, seed 6 |
...
| §6.3 `tab:uav-pillars`, `tab:uav-pillars-best` (`sec:res:uav:pillars`) | 🔴 **WITHHELD since 2026-09-18** — `pillars_hg` enforces the constraint its own demonstrations were built to satisfy ([`PENDING_20260918_pillars_geometry_redesign.md`](../../../logs_in_develop/Writing/Working_Space/data_status/PENDING_20260918_pillars_geometry_redesign.md)); `uav_results.py` gates the block off (`PILLARS_EXCLUDED`). Awaiting `pillars_xl`/`pillars_xxl`. Previously: pillars: S&C (**goal passed + collision-free**, v3.28) per projection configuration for all four models, full constraint set; best projected configuration per model; 7-configuration budget means; physical safety by method | CLOSURE_20260910 §2, DA_20260912 | [`uav_results.py`](uav_results.py) (tag `u7hg`) + [`CLOSURE_20260910`](../../../logs_in_develop/Gen15/Campaign_20260907_five_missions/CLOSURE_20260910_uav_engine_ladder_final.md), [`DA_20260912`](../../../logs_in_develop/Gen15/Campaign_20260907_five_missions/DA_20260912_pillars_diffusion_baseline_reference.md) | seed 6, 10 flights |
| §6.3 `tab:uav-scurve`, `tab:uav-controller` (`sec:res:uav:scurve`, `sec:res:uav:controller`) | s-curve unprojected listing; caveat: tracking controller (MuJoCo MPC vs brake-to-rest). **Endpoint projection re-run post-fix 2026-09-18 (tag `u18sc`): every cell 0.00, with 57–92 % of flights ended by the divergence guard — a failure case, reported with its abort counts** | CLOSURE_20260910 §3, DA_20260909_T5; [`DA_20260919`](DA_20260919_wave_1718_corridor_endpoint_and_scurve.md) §3 | [`uav_results.py`](uav_results.py) — `analysis_results_checkpoint/19-09-UAV-Pillars-Exclude/batch_uav_20260919_111701` + [`DA_20260909_T5`](../../../logs_in_develop/Gen15/Campaign_20260907_five_missions/DA_20260909_T5_mjpc_vs_pid_s_curve.md) | seed 6, 10 flights; 3 with MPC |
