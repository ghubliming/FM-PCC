            ...
            for variant_idx, variant in enumerate(projection_variants):
                ...
                try:
                    ...
                    for i in range(n_trials):
                        ...
                        for __ in range(0, len(sampled_trajectories_all[i]), plot_samples_every):          # Iterate over timesteps of sampled trajectories
                    ...
                    if config['write_to_file']:
                        np.savez(f'{save_path}/{variant}.npz', 
                                ...
                                sampled_trajectories_all=np.array(sampled_trajectories_all, dtype=object))  # MPC_NPZ_PATCH — parity with FMv3ODE npz (H-step plan foresight)
