...
def parse_top_level_args():
    parser = argparse.ArgumentParser(description='Train diffusion model with configurable seeds.')
    ...
    parser.add_argument('--wandb-project', type=str, default='fm-pcc-diffusion', help='W&B project name.')
