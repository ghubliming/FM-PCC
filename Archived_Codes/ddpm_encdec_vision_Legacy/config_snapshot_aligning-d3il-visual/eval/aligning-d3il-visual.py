...
base = {
    'ddpm_encdec_vision': {
        ...
        'horizon': 10, # 'horizon': 10 # ddpm act
        'window_size': 16, # 'window_size': 16 # ddpm act
        'obs_dim': 128,
        'action_dim': 3,
        'visual_input': True,
        'obs_seq_len': 16, # 'obs_seq_len': 1 # ddpm act
        'action_seq_size': 10, # 'action_seq_size': 10 # ddpm act
        'n_diffusion_steps': 100, # 'n_diffusion_steps': 100 # ddpm act
        'loss_type': 'l2',
        
        # dataset
        'loader': 'ignored',
        'max_path_length': 400, # 150
        ...
        'n_train_steps': 5e4, # 'n_train_steps': 5e5 # ddpm act
        'batch_size': 64, # 'batch_size': 64 # ddpm act
        'learning_rate': 5e-4, # 'learning_rate': 5e-4 # ddpm act
