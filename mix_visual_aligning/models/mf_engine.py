...
class MeanFlowEngine(nn.Module):
    """
    ...
    def __init__(
        ...
        # ── Gen14 GRAFT — visual passthrough (Gen8 "Option A" shape) ──
        # if_vision=True makes the trajectory model build VisualUNetTwoTime as its
        # velocity_net. Nothing else in this engine changes.
        ...
        self.if_vision = if_vision          # Gen14
        self.model = MFTrajectoryModel(
            state_dim=state_dim,
            seq_len=seq_len,
            freq_dim=freq_dim,
            depth=depth,
            ...
            if_vision=if_vision,            # Gen14
            vis_config=vis_config,          # Gen14
        )
    ...
    def sample(
        ...
        objective in MeanFlowODE._p_losses_meanflow. Each step passes the interval size h
