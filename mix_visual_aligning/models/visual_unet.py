...
class VisualUNet(nn.Module):
    ...
    Backbone: mix_visual_aligning.models.unet1d_temporal_cond.UNet1DTemporalCondModel
    ...
    def __init__(self, config):
        ...
        if self.film_mode == 'v2':
            from mix_visual_aligning.models.unet1d_temporal_film import UNet1DTemporalFiLMModel
            ...
            from mix_visual_aligning.models.unet1d_temporal_cond import UNet1DTemporalCondModel
