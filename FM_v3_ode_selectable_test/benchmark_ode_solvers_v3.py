...
def main() -> None:
    ...
    parser.add_argument("--seed", type=int, default=5, help="Model seed/checkpoint seed.")
    ...
    parser.add_argument("--ode-inference-steps", type=int, default=10, help="Alias kept aligned with flow steps.")
    ...
    parser_args = Parser().parse_args(experiment="plan_fm_v3_ode_selectable", seed=args.seed)
    ...
    default_out = os.path.join(os.path.dirname(__file__), "benchmark_outputs", f"{timestamp}_seed{args.seed}_{args.halfspace_variant}")
    ...
    meta = {
        ...
        "ode_inference_steps_v3": int(args.ode_inference_steps),
    ...
    print(f"seed={args.seed} | trials={args.n_trials} | horizon={horizon} | halfspace={args.halfspace_variant}")
    ...
    for solver_idx, solver in enumerate(solver_options):
        ...
        fm_model.ode_inference_steps_v3 = int(args.ode_inference_steps)
